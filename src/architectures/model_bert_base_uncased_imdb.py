...
class BertBaseUncasedIMDB:
    def __init__(self, repo: str, pretrained_model_name: str = "bert-base-uncased", **kwargs):
        ...
        Parametri:
          ...
          - pretrained_model_name (str): Nome del modello pre-addestrato (default "bert-base-uncased").
    ...
    def prepare_datasets(self, dataset_name: str = "imdb", split_train: str = "train", split_test: str = "test", max_samples: int = None):
        """
        Carica e prepara i dataset per il training e l'evaluation.

        Parametri:
          - dataset_name (str): Nome del dataset (default "imdb").
          - split_train (str): Nome dello split di training.
          - split_test (str): Nome dello split di evaluation.
    ...
    def compute_metrics(self, eval_pred):
        ...
        Ritorna:
          - Dizionario contenente le metriche.
        """
    ...
    def train(self, output_dir: str = "./results", num_train_epochs: int = 3, per_device_train_batch_size: int = 8, **kwargs):
        ...
        # Log finale con il report delle metriche, se disponibile
